	...
	namespace Internal
	{
		...
		Model* Shapes::Sphere(float radius, int vertexSpacing, const Color& color)
		{
			...
			for (float b = 0; b <= 180; b += space)
			{
				...
				{
					Maths::Vec3 v0 = Maths::Vec3((float)(radius * sin(ToRadians(a)) * sin(ToRadians(b))), (float)(radius * cos(ToRadians(a)) * sin(ToRadians(b))), (float)(radius * cos(ToRadians(b))));
					Maths::Vec2 tex0 = Maths::Vec2((b) / 360.0f, (a) / 360.0f);

					Maths::Vec3 v1 = Maths::Vec3((float)(radius * sin(ToRadians(a)) * sin(ToRadians(b - space))), (float)(radius * cos(ToRadians(a)) * sin(ToRadians(b - space))), (float)(radius * cos(ToRadians(b - space))));
					Maths::Vec2 tex1 = Maths::Vec2((b - space) / 360.0f, (a) / 360.0f);

					Maths::Vec3 v2 = Maths::Vec3((float)(radius * sin(ToRadians(a - space)) * sin(ToRadians(b))), (float)(radius * cos(ToRadians(a - space)) * sin(ToRadians(b))), (float)(radius * cos(ToRadians(b))));
					Maths::Vec2 tex2 = Maths::Vec2((b) / 360.0f, (a - space) / 360.0f);

					Maths::Vec3 v3 = Maths::Vec3((float)(radius * sin(ToRadians(a - space)) * sin(ToRadians(b - space))), (float)(radius * cos(ToRadians(a - space)) * sin(ToRadians(b - space))), (float)(radius * cos(ToRadians(b - space))));
		...
		Model* Shapes::Grid(float width, float depth, int xVertices, int zVertices, const Color& color)
		{
			...
			for (int i = 0; i < zVertices; i++)
			{
				...
				{
					ptr->position = Maths::Vec3(-width / 2.0f + j * (width / (float)(xVertices - 1)), 0, -depth / 2.0f + i * (depth / (float)(zVertices - 1)));
					ptr->normal = Maths::Vec3(0.0f, 1.0f, 0.0f);
